...
var style_Localite_Toece_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 3.2 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(47,50,54,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(47,50,54,1.0)'})}),
